...
public class OpenReportsFolder implements Action<App,File> {
    ...
    public File execute(App app, Map<String, Object> params) 
        ...
        final File selectedFile = (File)app.getAction(ActionCommands.DISPLAY_OPEN_DIALOG).execute(app, map);
            ...
            if(Desktop.isDesktopSupported()) {
                ...
                if(desktop.isSupported(Desktop.Action.OPEN)) {
                    try{
                        ...
                        app.getUIContext().showErrorMessage(e, "Error opening file: "+selectedFile);
                    }
                }else{
