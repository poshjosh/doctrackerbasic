 ...
 */
public class ExcelDataVerifier extends ExcelDataHandler<Doc> {
    ...
    public ExcelDataVerifier(App app) {
        super(app);
    }
    ...
    protected Doc handleRow(Doc previousDoc, Sheet sheet, Cell [] cells, int row, Set<Integer> failedRows) {
        ...
        for(int col : cols) {
            ...
            final SelectDaoBuilder<Task> sb = this.getApp().getSearchManager(Task.class).getSelectDaoBuilder(Task.class);
...
log((success ? "SUCCESS: " : " FAILED: ") + row);        
