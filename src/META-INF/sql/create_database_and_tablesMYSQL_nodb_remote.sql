...
create table unit
(
    unitid INTEGER(8) not null primary key,
...
insert into unit VALUES(12, 'Airforce Institute of Technology', 1);

drop table if exists appointment;
create table appointment
(
    appointmentid INTEGER(8) not null primary key,
...
insert into appointment VALUES(14, 'AFIT Commandant', 1, 12);

drop table if exists doc;
create table doc
(
    docid INTEGER(8) not null primary key,
...
create table task
(
    taskid INTEGER(8) not null primary key,
...
(
    taskresponseid INTEGER(8) not null primary key,
